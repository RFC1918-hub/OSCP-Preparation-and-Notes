...
* [Privilege Escalation](post-exploitation/privilege-escalation/README.md)
  * [MySQL UDF Root](post-exploitation/privilege-escalation/mysql-udf-root.md)
  * [Linux Privilege Escalation](post-exploitation/privilege-escalation/linux-privilege-escalation.md)
  * [Windows Privilege Escalation](post-exploitation/privilege-escalation/windows-privilege-escalation/README.md)
    * [Privilege Escalation with WINPWNAGE](post-exploitation/privilege-escalation/windows-privilege-escalation/privilege-escalation-with-winpwnage.md)
    * [Kernel Exploits](post-exploitation/privilege-escalation/windows-privilege-escalation/kernel-exploits.md)
    * [Admin to SYSTEM](post-exploitation/privilege-escalation/windows-privilege-escalation/admin-to-system.md)
    * [Searching for Passwords in REG](post-exploitation/privilege-escalation/windows-privilege-escalation/searching-for-passwords-in-reg.md)
    * [accesschk.exe](post-exploitation/privilege-escalation/windows-privilege-escalation/accesschk.exe.md)
    * [Potatoes for Lunch](post-exploitation/privilege-escalation/windows-privilege-escalation/potatoes-for-lunch.md)
